...
public class MainController {
	...
	public ModelAndView getMyplant(Principal principal, HttpSession session) {
	    ...
	    // 추가 0610
	    List<PostDto> gardnerPostList = postService.getPostByBoardNo(2);
	    List<PostDto> articlePostList = postService.getPostByBoardNo(1);
	    ...
	    Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
	      ...
	      switch(g_level){
	       ...
	       mav.addObject("gardnerPostList",gardnerPostList);
	       mav.addObject("articlePostList",articlePostList);
	       return mav;
